...
const boyi5 = _.keyBy(MyFun.ascRate(90,8001,1480,Boyi),'stay_date_CN');
const comp5_1 = _.keyBy(MyFun.flatRate(90,1001,1520,Comp),'stay_date_CN');
const comp5_2 = _.keyBy(MyFun.weekdayRate(90,1002,1600,Comp),'stay_date_CN');
const comp5_3 = _.keyBy(MyFun.fuckedRate(90,1003,1500,Comp),'stay_date_CN');
const comp5_4 = _.keyBy(MyFun.randomRate(90,1004,1500,Comp),'stay_date_CN');
const comp5_5 = _.keyBy(MyFun.weekdayRate(90,1005,1500,Comp),'stay_date_CN');
